...
|---|---|
| A/A0 | `DATA REQUIRED — M-1` |
| B | `DATA REQUIRED — M-1` либо `NOT BUILT` с причиной |
| C | `NOT MEASURED` |
| D | `NOT BUILT — запрещён до Gate P` |
...
| runner-labelled `M0-D1a` AVD artifact | `PRE-GATE / BLOCKED` | нет GPU capture и physical-device run; immutable source bundle не представлен |
...
immutable_source_bundle=not_reported
