...
- **M-1 presentation measurement (NeoUI v4 RFC, not a compositor).** Before
  ...
  [`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json); the probe
  ...
  [`m0-d2-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d2-adjudication.json) (Dioxus/Blitz
  ...
  **PASS**. `D1=Track D GO` and `D2=Dioxus+Blitz GO` are
  ...
  fast paths, and async hit-test / nested-scroll dispatch, and are **not**
  linked into `libneotavern_android_jni.so`.
...
[M0-D1a host adjudication](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json),
...
[M0-D2 host adjudication](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d2-adjudication.json),
