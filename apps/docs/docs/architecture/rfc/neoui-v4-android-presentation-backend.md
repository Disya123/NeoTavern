---
editUrl: https://github.com/Disya123/NeoTavern/edit/main/docs/rfc/neoui-v4-android-presentation-backend.md
---
...
**Physical criterion:** `PASS` in [perf-15-adjudication.json](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/perf-15-adjudication.json)
...
**Host stamp:** `PASS` in [perf-18-20-adjudication.json](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/perf-18-20-adjudication.json).
...
([`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json)). D1b может
