---
editUrl: https://github.com/Disya123/NeoTavern/edit/main/docs/rfc/m0-d2-physical-runbook.md
---

# M0-D2 physical capture runbook

**Status:** lab procedure. Program **M0-D2 PASS** is the host-side record
[`m0-d2-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d2-adjudication.json). Desktop Vulkan is
