...
host-side record [`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json), not
...
Primary pin: [`tools/renderdoc.pin.json`](https://github.com/Disya123/NeoTavern/blob/main/tools/renderdoc.pin.json) —
...
Preset: [`tools/renderdoc-frame-capture.preset.json`](https://github.com/Disya123/NeoTavern/blob/main/tools/renderdoc-frame-capture.preset.json).
...
([`tools/agi.pin.json`](https://github.com/Disya123/NeoTavern/blob/main/tools/agi.pin.json)). The existing
...
[`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json).
