---
editUrl: https://github.com/Disya123/NeoTavern/edit/main/docs/rfc/milestone-c-physical-runbook.md
---
...
Record: [`milestone-c-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/milestone-c-adjudication.json)
