...
| [M0-D1a physical capture runbook](m0-d1a-physical-runbook.md)                       | Lab procedure. Capture tool **RenderDoc v1.45**. AGI 3.3.3 archived `CAPTURED_BUT_NOT_REPLAYABLE`. D1a **BLOCKED** until a readable pass/resource tree. Not a PASS. D1b `NOT_STARTED`.                   |
