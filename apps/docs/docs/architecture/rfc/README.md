...
| RFC                                                                                 | Status                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [NeoUI v4 — Android presentation backend](neoui-v4-android-presentation-backend.md) | Draft **4.5**. Gate P **`GateP:P1` / PASSED**. Normative M0 **`ENTERED`**, not PASS. **M0-D1a PASS**. **M0-D1b PASS**. **M0-D2 STARTED**, not PASS. `D1=Track D GO` not granted.                         |
...
| [M0-D2 producer seam](m0-d2-probe.md)                                               | Program **M0-D2 STARTED**, not PASS. Moving sample after Dioxus/Blitz seam. 65-line paint hook. Physical capture still required. D1a JSON unchanged.                                                     |
| [M0-D2 physical capture runbook](m0-d2-physical-runbook.md)                         | Lab procedure. Generation-120 RenderDoc on the producer path.                                                                                                                                            |
