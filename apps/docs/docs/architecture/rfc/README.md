...
| [M0-D1a physical capture runbook](m0-d1a-physical-runbook.md)                       | Lab procedure. Capture tool **RenderDoc v1.45**. VkDevice-bound in-app capture; GLES 1437-byte file is `WRONG_API_CAPTURE`. D1a **BLOCKED** until a readable Vulkan tree. Not a PASS. D1b `NOT_STARTED`. |
