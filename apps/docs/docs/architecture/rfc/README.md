...
| RFC                                                                                 | Status                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [NeoUI v4 — Android presentation backend](neoui-v4-android-presentation-backend.md) | Draft **4.5**. Gate P **`GateP:P1` / PASSED**. Normative M0 **`ENTERED`**, not PASS. **M0-D1a PASS** (host-side). D1b may start. `D1=Track D GO` not granted. |
...
| [M0-D1b moving sample](m0-d1b-probe.md)                                             | **STARTED** after D1a PASS. Generation labels, Vello bake-once, capture frame 120. Not D1b PASS. D1a JSON unchanged. |
| [M0-D1b physical capture runbook](m0-d1b-physical-runbook.md)                       | Lab procedure. RenderDoc v1.45 at generation 120. Host schema `scripts/m0-d1b-adjudicate.mjs`. |
