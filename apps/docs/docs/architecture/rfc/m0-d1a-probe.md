...
([`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json)). Gate P remains
...
Record: [`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json)
...
| RFC §48 D1a **exit**                                 | **met** (host-side)              | Physical Vulkan capture + eight adjudication checks in [`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json). Probe log `capture=false` does not override that record. |
...
[`m0-d1a-adjudication.json`](https://github.com/Disya123/NeoTavern/blob/main/docs/rfc/m0-d1a-adjudication.json). Repeat D1a only if
