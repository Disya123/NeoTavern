---
editUrl: https://github.com/Disya123/NeoTavern/edit/main/docs/architecture/wire-contracts.md
---
...
- [Mobile FFI ABI](https://github.com/Disya123/NeoTavern/blob/main/crates/adapters/mobile-ffi/README.md) — the Phase 5
