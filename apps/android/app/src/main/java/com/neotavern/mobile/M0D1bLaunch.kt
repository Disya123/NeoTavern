...
/**
 * Launch extras for the debug-only M0-D1b moving-sample probe. No android.*
 * so JVM unit tests can cover parsing. Production [MainActivity] never reads
 * these.
 */
object M0D1bLaunch {
    const val EXTRA_FRAMES: String = "com.neotavern.mobile.M0_D1B_FRAMES"
    const val EXTRA_CAPTURE_FRAME: String = "com.neotavern.mobile.M0_D1B_CAPTURE_FRAME"
