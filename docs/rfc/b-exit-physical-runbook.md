...
| PERF-22 | [perf-22-adjudication.json](perf-22-adjudication.json) | `IMPLEMENTED` (platform fixture pending capture) |
| device-loss | [device-loss-adjudication.json](device-loss-adjudication.json) | `CPU_INJECTION` |
