...
**M0:** technical **PASS** after host-side [M0-D1a](m0-d1a-adjudication.json),
[M0-D1b](m0-d1b-adjudication.json), and [M0-D2](m0-d2-adjudication.json)
...
| ------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------ |
| M0-D1a        | [m0-d1a-adjudication.json](m0-d1a-adjudication.json) stamp `2026-08-17T17-18-59-431Z`                  | **PASS**                       |
| M0-D1b        | [m0-d1b-adjudication.json](m0-d1b-adjudication.json) stamp `2026-08-17T18-15-34-453Z`                  | **PASS**                       |
| M0-D2         | [m0-d2-adjudication.json](m0-d2-adjudication.json) stamp `2026-08-17T20-11-27-178Z`                    | **PASS**                       |
