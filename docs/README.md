...
- [Presentation boundary](architecture/presentation-boundary.md) — Milestone A **PASS**; Milestone B **PASS**; live Product Wire chat route (Milestone C STARTED, journey batch PASS, TalkBack SKIPPED, not RFC C PASS); WebView rollback.
