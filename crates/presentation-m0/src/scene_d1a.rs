//! Host-authored static D1a scene (RFC §48 stage 1).
//!
//! ```text
//! wallpaper
//! → GlassSurface A
...
//! ```
//!
//! Text is a shaped vector stand-in. Real Dioxus/Blitz glyphs are M0-D2.
...
pub const D1A_WIDTH: u32 = 320;
pub const D1A_HEIGHT: u32 = 200;

pub fn static_d1a_scene() -> NeoDisplayList {
