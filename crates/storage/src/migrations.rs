...
use crate::schema::{
    ...
    MIGRATION_17_NAME, MIGRATION_17_SQL, MIGRATION_18_CHECKSUM, MIGRATION_18_NAME,
    MIGRATION_18_SQL, MIGRATION_19_CHECKSUM, MIGRATION_19_NAME, MIGRATION_19_SQL,
    ...
    MIGRATION_7_CHECKSUM, MIGRATION_7_NAME, MIGRATION_7_SQL, MIGRATION_8_CHECKSUM,
    MIGRATION_8_NAME, MIGRATION_8_SQL, MIGRATION_9_CHECKSUM, MIGRATION_9_NAME, MIGRATION_9_SQL,
};
use crate::{
...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        id: 18,
        name: MIGRATION_18_NAME,
        risk: MigrationRisk::Low,
        transactional: true,
        sql: MIGRATION_18_SQL,
        checksum: MIGRATION_18_CHECKSUM,
    },
    Migration {
        id: 19,
        name: MIGRATION_19_NAME,
        risk: MigrationRisk::Low,
        transactional: true,
        sql: MIGRATION_19_SQL,
        checksum: MIGRATION_19_CHECKSUM,
    },
];
